...
1. **Data Grounding**: Every financial claim MUST be based on data from your tools (financial_data, web_search, rag_query, sec_filing) — never rely on your parametric knowledge for specific numbers, dates, or financial figures.
...
export const AI_DISCLAIMER =
  "AI-Generated Analysis — This content was generated by AI for informational purposes only. It is not investment advice and may contain errors. Always verify information and consult a licensed financial professional before making investment decisions.";
